...
@interface GMCheckBoxFormFieldCell ()<GMCheckBoxFormFieldDataModelDelegate>

@property (nonatomic, retain) GMCheckBoxFormFieldDataModel * model;
@property (nonatomic, retain) UIView *container;
@property (nonatomic, retain) UICollectionView *collectionView;

@end

@implementation GMCheckBoxFormFieldCell
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    self.headingLabel.text = @"TESTING";
    return self;
}
...
-(UICollectionView *)collectionView {
    ...
    if (!_collectionView) {
        ...
        self.model = [GMCheckBoxFormFieldDataModel modelFor:_collectionView];
...
- (CGRect)headingLabelFrame {
    ...
    CGRect frame = CGRectMake(marginX, marginTop, width, height + 10);
