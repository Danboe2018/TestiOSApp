...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    if([textField.accessibilityLabel isEqualToString:@"Guest Name:"]||[textField.accessibilityLabel isEqualToString:@"EmergencyName:"])
    {
    ...
    if([textField.accessibilityLabel isEqualToString:@"Zip:"])
    {
    ...
    if([textField.accessibilityLabel isEqualToString:@"Cell Phone:"]||[textField.accessibilityLabel isEqualToString:@"Alternate #"]||[textField.accessibilityLabel isEqualToString:@"Emergency Contact #"]|| [textField.accessibilityLabel isEqualToString:@"Home Phone:"]|| [textField.accessibilityLabel isEqualToString:@"Mobile:"]|| [textField.accessibilityLabel isEqualToString:@"Emergency Contact:"]||[textField.accessibilityLabel isEqualToString:@"Phone:"])
    {
